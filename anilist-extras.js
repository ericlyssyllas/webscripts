...
// ==UserScript==
// @name         AniList Extras
// @namespace    https://github.com/ericlyssyllas
// @version      1.5.3
// @description  Adiciona novas funcionalidades ao AniList.
// @author       Pain Tendo & pilar6195
	...
	const anilist = {
		overview: {
			...
			async init() {
                ...
                this.addAnicenterLink(this.currentData.mal_id, isAnime);
				this.addMalScore();
            ...
            addAnicenterLink(malID, isAnime) {
				if ($('.AniCenter') || !$('.sidebar')) return;
				...
				const malLink = anilist.helpers.createElement('a', {
					[attrName]: '',
					class: 'external-link AniCenter',
					target: '_blank',
					href: `https://anicenter.jyz.com.br/${isAnime ? 'anime' : 'manga'}/${malID}`,
				}, {
					'--link-color': '#f9ab00',
				});
				...
				const malLinkImg = anilist.helpers.createElement('img', {
					[attrName]: '',
					class: 'icon',
					src: 'https://anicenter.jyz.com.br/icon/favicon-32x32.png',
				});
				malLinkImgContainer.append(malLinkImg);
				...
				malLinkText.innerText = 'AniCenter';
